...
export function CallToAction() {
  return (
    <section className='py-24 bg-gradient-to-b from-white to-[#D3DCFF] overflow-x-clip'>
      <div className='container'>
        <div className='max-w-[540px] mx-auto relative'>
          ...
          <Image src={startImg} alt="start Img" width={360} className='absolute -left-[350px] -top-[137px]'/>
          <Image src={springImg} alt='spring img' width={360} className='absolute -right-[331px] -top-[19px]' />
        </div>
