...
export const Hero = () => {
  ...
  return (
    <section ref={heroRef} className='pt-8 pb-20 md:pt-4 md:pb-10 bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,#183EC2,#EAEEFE_100%)] overflow-x-clip'>
      <div className="container md:flex items-center">
        ...
        <div className='mt-20 md:mt-0 md:h-[648px] md:flex-1 relative'>
          ...
          />
          <motion.img src={cylinderImg.src}
            style={{
              translateY: translateY
            }}
            alt='cylinder' className='hidden md:block absolute -top-8 -left-32 ' width={220} height={220} />
          <motion.img src={noodleImage.src}
            style={{
              rotate: 30,
              translateY: translateY
            }}
            alt='noodle image' width={220} height={220} className='hidden lg:block top-[524px] left-[448px]  rotate-[30deg] absolute ' />
        </div>
      </div>
    </section>
  )
